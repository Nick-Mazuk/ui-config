...
type Shade =
    ...
    | 'd800'
    | 'd900'
type LooseColorGroup = Record<string, Color>
type ColorGroup = Record<Shade, Color> & LooseColorGroup
type RequiredColors =
    | 'black'
    | 'white'
    | 'transparent'
...
const createTailwindColors = (colors: Colors) => {
    const tailwindColors: Record<string, unknown> = {}
...
export const tailwindColors = createTailwindColors(colors)
